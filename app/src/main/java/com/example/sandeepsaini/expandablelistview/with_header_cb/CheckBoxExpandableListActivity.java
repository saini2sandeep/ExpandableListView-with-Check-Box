...
public class CheckBoxExpandableListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_box_expandable_list);
    ...
    private void setupReferences() {
        ...
        for (FruitCategory category : fruitCategoryArrayList) {
            ...
            mapParent.put(ConstantManager.Parameter.IS_CHECKED, category.getIsChecked());
        ...
        CheckBoxExpandableListAdapter checkBoxExpandableListAdapter = new CheckBoxExpandableListAdapter(this, parentItems, childItems);
        expandableListView.setAdapter(checkBoxExpandableListAdapter);
    }

    @OnClick(R.id.toolbar_back_button_iv)
    void toolbarBackButtonClick(View v) {
        finish();
    }
    ...
    private void getSelectedData() {
        ...
        fruitCategoryHM = ConstantManager.parentItems;
